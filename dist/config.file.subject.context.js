...
const ConfigFileSubjectContext = new SettingsFileSubjectContext(ConfigCacheObserverSingleton.getInstance(), new ConfParserStrategy(), PathUtilities.getConfigFilePath());
export default ConfigFileSubjectContext;
//# sourceMappingURL=config.file.subject.context.js.map